...
class UserController extends AbstractController
{
    ...
    public function update(User $user, Request $request, LoggerInterface $appUserInfoLogger, FileService $uploader): Response
    {
        ...
        if($formulario->isSubmitted() && $formulario->isValid()){
            ...
            $mensaje = 'Datos del usuario ' .$user->getDisplayname(). ' actualizados correctamente';
    ...
    public function delete(User $user, Request $request, LoggerInterface $appUserInfoLogger, FileService $uploader): Response
    {
        ...
        if($formulario->isSubmitted() && $formulario->isValid()){
            ...
            $mensaje = 'Usuario ' .$user->getDisplayname(). ' eliminado correctamente';
            $this->addFlash('success', $mensaje);
            $appUserInfoLogger->info($mensaje);
